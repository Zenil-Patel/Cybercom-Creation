...
INSERT INTO employees VAlue(100,'Steven','King','steven.king@sqltutorial.org','515.123.4567','1987-06-17',4,24000.00,NULL,9);
...
INSERT INTO employees VALUES (208,1234,'Gietz','william.gietz@sqltutorial.org','515.123.8181','1994-06-07',1,8300.00,205,11);
...
select * from employees where department_id = 9 and manager_id= 100;


select * from employees where employee_id = 100 or manager_id = 100;

select * from employees where last_name in ('Russell', 'King', 'Partners');

select * from employees where email like '%sql%';

select * from employees where employee_id like '_0_';

select * from employees where employee_id not like '1%';

select first_name, salary from employees where salary between 5000 and 8000;
select first_name, salary from employees where salary not between 5000 and 8000;
